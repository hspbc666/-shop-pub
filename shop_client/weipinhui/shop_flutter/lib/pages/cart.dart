...
class _CartState extends State<CartPage> {
  ...
  void gotoConfirmOrderPage() {
    if (_selectedCartIndexes.isNotEmpty) {
      List<CreateOrderReqSimpleCartItemList> simpleCartItemList = List.empty(growable: true);
      for (var item in _selectedCartIndexes) {
        QueryCartRespData queryCartRespData = _dataList.elementAt(item);
        CreateOrderReqSimpleCartItemList createOrderReqSimpleCartItem = CreateOrderReqSimpleCartItemList();
        createOrderReqSimpleCartItem.goodsId = queryCartRespData.goodsId;
        createOrderReqSimpleCartItem.quantity = queryCartRespData.quantity;
        simpleCartItemList.add(createOrderReqSimpleCartItem);
      }
      Navigator.push(context, MaterialPageRoute(builder: (context) => OrderConfirmPage(simpleCartItemList)));
    }
  }
